...
async function Pokemon({ params }: {
  ...
  return (
    <>
     {!res.ok ? 
      <Box display='flex' justifyContent='center' alignItems='center' flexDirection='column' mt={50}>
        <Image src='/emptyball.png' alt='pokemon not found'/>
        <Text fontSize='lg' fontWeight='bold' color="#3C5AA6">Pokemon not found</Text>
      </Box> :
